...
define(
  ...
  function ( BLLSymbols, Color, Solvent, SoluteColorScheme, Strings ) {
    "use strict";
    ...
    Solute.POTASSIUM_PERMANGANATE = new Solute(
      Strings.POTASSIUM_PERMANGANATE,
