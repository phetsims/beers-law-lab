...
define( function( require ) {
  ...
  // Together support
  together && together.addComponent( Solute.DRINK_MIX, 'concentrationScreen.solutes.drinkMix' );
  together && together.addComponent( Solute.COBALT_II_NITRATE, 'concentrationScreen.solutes.cobaltIINitrate' );
  together && together.addComponent( Solute.COBALT_CHLORIDE, 'concentrationScreen.solutes.cobaltChloride' );
  together && together.addComponent( Solute.POTASSIUM_DICHROMATE, 'concentrationScreen.solutes.potassiumDichromate' );
  together && together.addComponent( Solute.POTASSIUM_CHROMATE, 'concentrationScreen.solutes.potassiumChromate' );
  together && together.addComponent( Solute.NICKEL_II_CHLORIDE, 'concentrationScreen.solutes.nickelIIChloride' );
  together && together.addComponent( Solute.COPPER_SULFATE, 'concentrationScreen.solutes.copperSulfate' );
  together && together.addComponent( Solute.POTASSIUM_PERMANGANATE, 'concentrationScreen.solutes.potassiumPermanganate' );
