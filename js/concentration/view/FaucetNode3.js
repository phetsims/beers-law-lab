...
define( function( require ) {
  ...
  var PIPE_Y_OFFSET = 32; // offset of pipe in spout image
  var THUMB_SIZE = new Dimension2( 25, 40 );
  ...
  function FaucetNode3( faucet, mvt ) {
    ...
    // child nodes
    var pipeNode = new Image( BLLImages.getImage( "faucet3_pipe.png" ) );
    var spoutNode = new Image( BLLImages.getImage( "faucet3_spout.png" ) );
    ...
    // layout
    {
      ...
      // slider
      slider.x = spoutNode.left + 8;
      slider.y = spoutNode.top + 6;
    }
