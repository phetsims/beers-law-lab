...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(BeersLawSolutionIO)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> BeersLawSolutionIO<br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
      ...
      "supertype": "ParametricTypeImplIO.<BeersLawSolutionIO, VoidIO>",
      "typeName": "FunctionIO.(BeersLawSolutionIO)=>VoidIO"
    },
    "FunctionIO.(BeersLawSolutionIO,NullableIO.<BeersLawSolutionIO>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "BeersLawSolutionIO",
        "NullableIO.<BeersLawSolutionIO>",
        "VoidIO"
      ],
      "supertype": "ParametricTypeImplIO.<BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO>, VoidIO>",
      "typeName": "FunctionIO.(BeersLawSolutionIO,NullableIO.<BeersLawSolutionIO>)=>VoidIO"
    },
    ...
    "NullableIO.<BeersLawSolutionIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<BeersLawSolutionIO>",
      "typeName": "NullableIO.<BeersLawSolutionIO>"
    },
    "NullableIO.<BooleanIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "ParametricTypeImplIO.<BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO>, VoidIO>"
    },
    "ParametricTypeImplIO.<BeersLawSolutionIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<BeersLawSolutionIO, VoidIO>"
    },
    "ParametricTypeImplIO.<BeersLawSolutionIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<BeersLawSolutionIO>"
    },
    ...
    "PropertyIO.<BeersLawSolutionIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<BeersLawSolutionIO>",
      "typeName": "PropertyIO.<BeersLawSolutionIO>"
    },
