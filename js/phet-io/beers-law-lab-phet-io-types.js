...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(BeersLawSolutionIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<BeersLawSolutionIO, VoidIO>",
    ...
    "FunctionIO.(BeersLawSolutionIO,NullableIO.<BeersLawSolutionIO>)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO>, VoidIO>",
    ...
    "NullableIO.<BeersLawSolutionIO>": {
      ...
      "supertype": "ParametricTypeIO.<BeersLawSolutionIO>",
    ...
    "ParametricTypeIO.<BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<BeersLawSolutionIO, NullableIO.<BeersLawSolutionIO>, VoidIO>"
    },
    "ParametricTypeIO.<BeersLawSolutionIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<BeersLawSolutionIO, VoidIO>"
    },
    "ParametricTypeIO.<BeersLawSolutionIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<BeersLawSolutionIO>"
    },
