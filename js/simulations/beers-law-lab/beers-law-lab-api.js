...
define( function( require ) {
  ...
  var TComboBox = require( 'PHET_IO/api/sun/TComboBox' );
  var TDerivedProperty = require( 'PHET_IO/api/axon/TDerivedProperty' );
  var TFaucet = require( 'PHET_IO/api/scenery-phet/TFaucet' );
  ...
  var TMomentaryButton = require( 'PHET_IO/api/sun/buttons/TMomentaryButton' );
  ...
  var TPanel = require( 'PHET_IO/api/sun/TPanel' );
  var TString = require( 'PHET_IO/api/TString' );
  var TTandem = require( 'PHET_IO/api/tandem/TTandem' );
