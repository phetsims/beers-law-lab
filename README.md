Beer's Law Lab
=============
"Beer's Law Lab" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/beers-law-lab/latest/beers-law-lab_en.html" target="_blank">Click here to
run "Beer's Law Lab".</a>
...
(5) Open in the browser: `http://localhost/beers-law-lab/beers-law-lab_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/beers-law-lab/build/adapted-from-phet/beers-law-lab_en_adapted-from-phet.html` (You will
